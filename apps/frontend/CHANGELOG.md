...
- Increased the maximum range of gauge charts for fine and coarse particulate matter (`PM₀.₃` and `PM₀.₅`) and TVOC values:
  - Updated `maxValue` from `500` to `1500` to better reflect real-world measurement ranges.
