...
- Improved Docker build logging for better visibility during image creation:
  - Removed `>/dev/null` redirection to display real-time build output in the console.
